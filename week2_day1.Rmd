...
Note: In the above code, we are using the %>% (pipe) operator. This allows us to connect functions within our code so that it performs each step at a time. We start off with our data (SDR_2023_Data), then use the pipe operator to use the miss_var_summary() function, and then again to use the arrange() function. 
