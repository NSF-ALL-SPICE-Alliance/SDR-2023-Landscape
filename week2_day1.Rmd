...
```{r}
str(SDR_2023_Data) # looking at the data structure
```
...
```{r}
SDR_2023_Data %>% select(c("Country", "Population with access to clean fuels and technology for cooking (%)", "CO₂ emissions from fuel combustion per total electricity output (MtCO₂/TWh)","Population with access to electricity (%)","Renewable energy share in total final energy consumption (%)")) %>%  pivot_longer(cols = c("Population with access to clean fuels and technology for cooking (%)", "CO₂ emissions from fuel combustion per total electricity output (MtCO₂/TWh)","Population with access to electricity (%)","Renewable energy share in total final energy consumption (%)"), names_to = "Indicator")
```
