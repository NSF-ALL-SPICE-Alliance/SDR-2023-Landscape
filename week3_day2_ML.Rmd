...
```{r}
completely_na_countries  <- missing_data_by_country$country[missing_data_by_country$pct_miss > 99]
...
With the new list of 179 countries (few of them are regions) let's take another look at missinf data by variable/column
...
To answer this question, we train a random forest model to make predictions of maternal mortality scores for each country and then ask the model which SDG Scores were the most important in making it's prediction
