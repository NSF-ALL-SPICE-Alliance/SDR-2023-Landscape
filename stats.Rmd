...
```{r}
ggcorrplot::ggcorrplot(cor, method = "circle", type = "lower", lab = TRUE, lab_size = 2) +
...
- There is a negative correlation between Goal 9 scores and Goal 12 scores: correlation coefficient (-0.82 out of a possible -1)
  ...
  - What does this look like on sscatter plot?
...
1. Plot a linear regression of 2 sdg scores, not the ones in this lesson, with ggplot() and geom_smooth()
  
    - add a correlation coefficient to the plot with stat_cor()
    ...
    - describe what you see in 4 - 6 sentences
  
2. Take a further look at the correlation matrix plotted above

    - in 4-6 sentences, come up with a hypotheses for the positive or negative correlation between 2 goals